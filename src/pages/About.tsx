...
export default function About({ lang }: AboutProps) {
  ...
  return (
    <main>
      {/* Page hero */}
      <section className="relative bg-[#0A1628] pt-36 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.span
            ...
            className="inline-block px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/70 text-xs font-semibold uppercase tracking-widest mb-5"
          >
